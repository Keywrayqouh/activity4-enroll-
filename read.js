var fs = require('fs');
exports.read = function (filename, response) {
    fs.readFile(filename, "utf8", function (err, data) {
        ...
        var table = "<html><head><title>Document</title>" +
            ...
            "tr:hover {background-color:rgba(91, 224, 245,0.4);}body{background-color: url('https://www.google.com/url?sa=i&source=images&cd=&ved=2ahUKEwjO4cG4oNfkAhUE7GEKHTGFAQoQjRx6BAgBEAQ&url=https%3A%2F%2Fblog.visme.co%2Fsimple-backgrounds%2F&psig=AOvVaw3xOFyMD279GeEugP3zbtJI&ust=1568788962949185');" +
